...
const PopUpUser = ({username}:Props) => {
  ...
  return (
    <div className="z-50 flex flex-col justify-start items-start md:bg-darkLighter md:rounded-[5px] md:py-5 md:px-5 gap-5 md:min-w-[200px] md:max-w-[200px]">
        <NavLink to='/'><h3 className="poppins leading-snug text-white font-semibold text-base overflow-hidden">{username}<br/><span className="text-xs font-medium text-lightGray">View Profile</span></h3></NavLink>
