        ...
        <div className="w-full relative flex justify-center">
            <div className="max-w-[1300px] flex flex-col text-center items-center mt-12 px-4 md:px-0">
                ...
                <form className="flex flex-col gap-2 mt-10">
                        ...
                        inputError.map((err) => {
                            if (err.input === "username") {
                                return (
                                    <h1
                                        key={err.input}
                                        className="poppins text-red-700 text-sm text-start"
                                    >
                                        {err.message}
                                    </h1>
                                );
                    ...
                    <button
                        disabled={recaptchaPassed ? false : true}
                        type="button"
                        onClick={() => handleSighUp(authDataSignUp)}
                        className="poppins text-white text-xl bgGradient font-semibold rounded-full py-4 mt-2 px-20 disabled:opacity-50"
                    >
